...
import { ClashRoyalePacket } from './ClashRoyalePacket';

/**
 * Packetizer for Clash Royale
 */
export class ClashRoyalePacketizer extends PacketizerBase {
  constructor() {
    super();
  ...
  protected packetize(): void {
    ...
    const parsedPacket: ClashRoyalePacket = new ClashRoyalePacket(packetId, length, unknown, version, payload);
